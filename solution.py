...
class SOLUTION:
    ...
    def Create_World(self):
        ...
        pyrosim.Send_Cube(name="LeftBarrier", pos=[-5, 5, 1], size=[0.2, 15, 2], mass=200)  # Left wall
        pyrosim.Send_Cube(name="RightBarrier", pos=[5, 5, 1], size=[0.2, 15, 2], mass=200)  # Right wall
